...
const controllerRoutes = async (app: Express, router: Router) => {
    app.get(apiPaths._base + apiPaths.controllers, function (req: Request, res: Response, next: NextFunction) {
    ...
    app.post(apiPaths._base + apiPaths.controllers, function (req: Request, res: Response, next: NextFunction) {
        res.send({ message: "submitted successfully" });
    });

    app.get(apiPaths._base + apiPaths.controllers_id, function (req: Request, res: Response, next: NextFunction) {
